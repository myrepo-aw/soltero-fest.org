(function($){
  ...
  $('.counter-box[data-countdown]').each(function() {
    ...
    $this.countdown(finalDate, function(event) {
      ...
      + '<li class="days"><strong class="day2">%D</strong><span class="d-block">Días</span></li>'
      + '<li class="hours"><strong class="hours2">%H</strong><span class="d-block">Horas</span></li>'
      + '<li class="minutes"><strong class="min2">%M</strong><span class="d-block">Minutos</span></li>'
      + '<li class="seconds"><strong class="sec2">%S</strong><span class="d-block">Segundos</span></li>'));
    });
  });
  /* counter */
